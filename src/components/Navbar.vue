    ...
    <div class="container">
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav me-auto">
          <li class="nav-item">
            <a class="nav-link" href="/lab1"
              ><i class="fa-solid fa-circle-info"></i> Lab 1</a
            >
          </li>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="/bai3lab3">Bài 3</a></li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="#"
              ><i class="fa-solid fa-circle-info"></i> Lab 7</a
            >
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#"
              ><i class="fa-solid fa-circle-info"></i> Lab 8</a
            >
          </li>
        </ul>
      </div>
